...
export const Sections: FC<SectionProps> = () => {
  ...
  return (
    <div className="relative z-10 flex w-full flex-col">
      ...
      <div
        id="sections"
        className="flex h-screen w-screen flex-col items-center justify-center space-x-20 p-10 sm:flex-col sm:justify-center sm:p-10 md:flex-row md:justify-normal md:p-0"
        ref={aboutRef}
      >
        ...
        <div
          className={`flex h-[600px] w-full overflow-auto sm:w-full md:w-1/2 md:justify-start ${styles.maskedBottom} pb-10`}
        >
